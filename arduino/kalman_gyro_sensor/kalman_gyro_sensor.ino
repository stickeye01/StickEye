...
/*====================================================
 * initialize servo and ultra 
=======================================================*/
  servo[UB].attach(servoMotorPin[UB]);
  delay(10);
  servo[C].attach(servoMotorPin[C]);
  delay(10);
  servo[UB].write(0);
  delay(15);
  servo[C].write(90);
  ...
  pinMode(trigPin[UB], OUTPUT);
  pinMode(echoPin[UB], INPUT);
  delay(3);
...
void updateGyroValue() {
  ...
  Serial.print("roll : "+String(kalAngleX)); Serial.print("\t");
  ...
  Serial.print("pitch : "+ String(kalAngleY)); Serial.print("\t");
   */
/*
